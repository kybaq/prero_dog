...
from dog_eye_detect.views import FilesList, FileView, FileDeleteView, IndexView, Eye_Predict
from dog_eye_detect.views import SelectPredFileView, SelectFileDelView, FileDeleteView, UploadView , UploadSuccessView

app_name = 'dog_eye_detect'

urlpatterns = [
    path('', IndexView.as_view(), name='IndexView'),
    path('predict/', Eye_Predict.as_view(), name='APIpredict'),
